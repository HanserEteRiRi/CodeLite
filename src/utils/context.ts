...
// 根据模型名称匹配对应的最大输出 token 限制
// Look up max output token limits matching the given model name
...
// 解析并返回最终的最大输出 token 数，优先使用用户配置值
// Resolve the effective max output tokens, prioritizing user-configured value
