...
// 尝试读取文件内容，文件不存在时返回 null 而不抛出异常
// Try to read a file; return null if the file does not exist instead of throwing
...
// 构建系统提示词：合并行为指令、权限摘要、技能列表、MCP 信息和 CLAUDE.md
// Build the system prompt: combine behavioral instructions, permission summary, skills, MCP info, and CLAUDE.md
export async function buildSystemPrompt(
  ...
  const parts = [
    'You are code-lite, a terminal coding assistant.',
